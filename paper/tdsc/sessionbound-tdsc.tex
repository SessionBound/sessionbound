...
not dominate this small-dataset benchmark. The likely dominant costs are
safe-view predicates, repeated session-claim lookup, PL/pgSQL wrapper
dispatch, and row materialization in the reference runtime.
...
We also ran a prior synthetic scale sweep over 1k, 10k, and 100k scoped
expense rows. For aggregate-by-category queries, raw PostgreSQL p50 was
0.41, 2.70, and 14.77 ms, while full SessionBound p50 was 84.41, 688.66,
and 6742.55 ms. For top-k ordering, raw p50 was 0.40, 2.54, and 15.62 ms,
while full SessionBound p50 was 82.44, 661.62, and 6965.09 ms. These
results show that the PL/pgSQL prototype has substantial scale-sensitive
overhead and should be treated as a security reference implementation,
not as an optimized execution engine.
