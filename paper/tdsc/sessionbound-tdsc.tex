...
1k/10k/100k scoped rows shows that both current accounting paths remain
unoptimized: wrapper p50 latency is 75.6--92.6 ms at 1k rows and
6.11--6.24 s at 100k rows, while native hook/executor accounting is
79.8--95.5 ms at 1k rows and 6.18--6.30 s at 100k rows. A separate
