...
The latest hardening run used Docker Compose with PostgreSQL 16.14 and the
FastAPI SessionBoundDB prototype. The repository branch was
\texttt{c95e6ed}. The default seed
...
The hardening results improve direct SQL-structure coverage and make
