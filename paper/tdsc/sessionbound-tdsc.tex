...
100k-row detail-release accounting from multi-second latency to
...
with independent query-count, result-row, and unique-entity counters;
...
migration review, external audit retention, and WORM anchoring.
...
smoke tests, and diagnostic 1k/10k/100k scale benchmarks, not optimized
...
100k-row paths; production work must optimize result accounting, backend
