...
This is the canonical public evaluation for the current SessionBound prototype. It checks allowed analytical SQL, denied boundary violations, transparent safe-view scope filtering, payload aggregation blocking, and budget enforcement.
