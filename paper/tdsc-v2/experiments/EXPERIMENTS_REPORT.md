...
| Credential-token edge cases | 5 tests | `raw_results/credential_token_1783221767.json` |
...
revocation are enforced, but strict credential-id binding, token replay
blocking across a second credential, and same-session rebind blocking are
not implemented in the measured code.
