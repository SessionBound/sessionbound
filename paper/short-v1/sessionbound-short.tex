...
\author{Minmin Wu\\China Telecom Global Limited\\\texttt{wuminmin@chinatelecomglobal.com}}
\date{}
\hypersetup{
...
\end{abstract}
\noindent\textbf{Code availability.} Code and evaluation artifacts are
available at \url{https://github.com/SessionBound/sessionbound}.
\par\noindent\textbf{Paper.} The arXiv version is available at
...
This paper presents SessionBound, a control-plane and database-runtime
architecture for turning approved enterprise tasks into budgeted
database sessions. It makes three contributions. First, it identifies
enterprise task approval as the missing layer between agent delegation
and database enforcement. Second, it proposes a control-plane and
runtime architecture for turning approvals into budgeted database
sessions. Third, it reports a PostgreSQL prototype that validates core
enforcement behavior and measures small-query overhead.
...
database enforcement. The agent can try. The database decides.
