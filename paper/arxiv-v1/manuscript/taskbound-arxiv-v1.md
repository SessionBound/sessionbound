...
## Motivation: Enterprise Tasks Are Approved Above the Database

### SaaS is strong at fixed workflows and weak at temporary analysis
...
### Enterprise approval is not database policy authoring
...
### Running example: travel reimbursement anomaly review
...
## Control Plane: Templates, Applications, Approvals, and Budgets
...
### Business users approve tasks, not policies
...
### Session binding and credential-token binding
...
### Safe views as the query surface
...
## Prototype Implementation and Production Hardening
...
### Task approval is not a database policy
...
### The runtime should not be an LLM judge
...
### Filtering, denial, and SQL semantics
...
### Budgets as authority accounting
...
### Composition with existing authorization systems
...
### OAuth, agent identity, and authenticated delegation
...
### PAuth and task-scoped service operations
...
### Data Product MCP and enterprise data product governance
...
### Oracle DDS and database-enforced access control
...
### Zanzibar and relationship-based authorization
...
### Differential privacy, inference control, query auditing, and DLP
