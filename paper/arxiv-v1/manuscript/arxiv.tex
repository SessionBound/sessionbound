...
reproduce the results. The detailed validation run passed 18 of 18
tested scenarios. The core allowed query patterns worked, and direct
sensitive-field, raw-schema, mutation, DDL, query-budget, unique-row
disclosure-budget, and payload-aggregation violations were denied.
...
\subsubsection{13.1 Task approval is not a database
...
\subsubsection{13.2 The runtime should not be an LLM
...
\subsubsection{13.3 Filtering, denial, and SQL
...
\subsubsection{13.4 Budgets as authority
...
\subsubsection{13.5 Composition with existing authorization
...
\subsection{14. Related Work}\label{related-work}}

\hypertarget{oauth-agent-identity-and-authenticated-delegation}{%
\subsubsection{14.1 OAuth, agent identity, and authenticated
...
\subsubsection{14.2 PAuth and task-scoped service
...
\subsubsection{14.3 Data Product MCP and enterprise data product
...
\subsubsection{14.4 Oracle DDS and database-enforced access
...
\subsubsection{14.5 Zanzibar and relationship-based
...
\subsubsection{14.6 Differential privacy, inference control, query
auditing, and
...
\subsection{15. Future Work}\label{future-work}}
